...
Mouse.setup = function () {
    instance$1 = instance$1 || new Mouse();
    return instance$1;
};
...
Mouse.destroy = function(){
    instance$1._removeDocumentListener();
    instance$1 = null;
};
...
const NumberInput_Internal = function (stepValue, dp, onBegin, onChange, onFinish, onError) {
...
function Range(parent, object, value, params) {
    ...
    params          = params          || {};
    params.onChange = params.onChange || this._onChange;
    params.step     = params.step || DEFAULT_STEP$1;
    params.dp       = (params.dp != null) ? params.dp : DEFAULT_DP$1;
...
const StringOutput = function (parent, object, value, params) {
    Output.apply(this, arguments);
};
...
Panel.prototype.addCanvas = function (params) {
    return this._addComponent(Canvas,params);
};

Panel.prototype.addSVG = function (params) {
    return this._addComponent(SVG,params);
};
...
ControlKit$1.prototype = Object.create(EventDispatcher.prototype);
ControlKit$1.prototype.constructor = ControlKit$1;
 ...
 * @param {String} [params.dock=false] - (Experimental) Indicates whether the panel should be docked to either the left or right window border (depending on params.align), docked panels height equal window height
  * @returns {Panel}
 */
ControlKit$1.prototype.addPanel = function (params) {
 ...
 */
ControlKit$1.prototype.update = function () {
...
ControlKit$1.prototype.historyIsEnabled = function () {
    return this._historyEnabled;
};

ControlKit$1.prototype.statesAreEnabled = function(){
    return this._statesEnabled;
};

ControlKit$1.prototype.panelsAreClosable = function () {
    return this._panelsClosable;
};

ControlKit$1.prototype._enable = function(){
...
ControlKit$1.prototype._disable = function(){
    var i = -1, p = this._panels, l = p.length;
    while (++i < l){
        p[i].disable();
    }
...
ControlKit$1.prototype.enable = function () {
    this._enable();
    this._enabled = true;
};
...
ControlKit$1.prototype.disable = function () {
    this._disable();
    this._enabled = false;
};
...
ControlKit$1.prototype.setShortcutEnable = function(char){
    this._shortcutEnable = char;
};

ControlKit$1.prototype.onHistoryStatePush = function () {
    this.dispatchEvent(new Event_(this, MenuEvent.UPDATE_MENU, null));
};

ControlKit$1.prototype.onHistoryStatePop = function () {
    this.dispatchEvent(new Event_(this, ComponentEvent.UPDATE_VALUE, {origin: null}));
    this.dispatchEvent(new Event_(this, MenuEvent.UPDATE_MENU, null));
};

ControlKit$1.prototype.loadSettings = function(data){
...
ControlKit$1.prototype._loadState = function(){
    State.load(this.loadSettings.bind(this));
};

ControlKit$1.prototype._saveState = function(){
...
ControlKit$1.prototype.getNode = function () {
    return this._node;
};

ControlKit$1.destroy = function(){
    Mouse.get().destroy();
    Options.get().destroy();
    Picker.get().destroy();
    initiated = false;
...
export { ControlKit$1 as default };
